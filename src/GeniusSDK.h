...
GNUS_VISIBILITY_DEFAULT double       GeniusSDKGetBalance();
...
GNUS_VISIBILITY_DEFAULT void GeniusSDKMintTokens( double amount, const char *transaction_hash, const char *chain_id,
                                                  const char *token_id );
GNUS_VISIBILITY_DEFAULT GeniusAddress GeniusSDKGetAddress();
GNUS_VISIBILITY_DEFAULT bool          GeniusSDKTransferTokens( double amount, GeniusAddress *dest );
GNUS_VISIBILITY_DEFAULT double        GeniusSDKGetCost( const JsonData_t jsondata );
