...
// ============================================================================
// Static state — initialized by InitGeniusSDKAndroid
// ============================================================================
...
namespace
{
    ...
    // Cached JNI class and method references for BackgroundServiceManager
    ...
    // Background configuration loaded from background_config.json
...
namespace sgns
{
    ...
    // ========================================================================
    // InitGeniusSDKAndroid — called from JNI_OnLoad in Android.cpp
    // ========================================================================
    void InitGeniusSDKAndroid( JavaVM *vm )
    {
        LOGI( "InitGeniusSDKAndroid: caching JavaVM pointer" );
        g_jvm = vm;
    }

    // ========================================================================
    // GetJNIEnv — thread-safe JNIEnv retrieval
    // Pattern: AndroidSecureStorage::GetJNIEnv() in Android.cpp
    // ========================================================================
    JNIEnv *GetJNIEnv()
    {
        if ( g_jvm == nullptr )
