...
if (NOT THIRDPARTY_DIR)
  message(FATAL_ERROR "THIRDPARTY_DIR not found")
endif()
print("THIRDPARTY BUILD DIR: ${THIRDPARTY_DIR}")

# --------------------------------------------------------
# Set config of GTest
set(GTest_DIR "${THIRDPARTY_DIR}/GTest/lib/cmake/GTest")
set(GTest_INCLUDE_DIR "${THIRDPARTY_DIR}/GTest/include")
find_package(GTest CONFIG REQUIRED)
include_directories(${GTest_INCLUDE_DIR})

# --------------------------------------------------------
# Set config of protobuf project
set(Protobuf_DIR "${THIRDPARTY_DIR}/grpc/lib/cmake/protobuf")
set(Protobuf_INCLUDE_DIR "${THIRDPARTY_DIR}/grpc/include/google/protobuf")
...
if (${CMAKE_SYSTEM_NAME} STREQUAL "Windows")
  ...
  set(Protobuf_DIR  "${THIRDPARTY_DIR}/grpc/build/third_party/protobuf/cmake")
  set(Protobuf_INCLUDE_DIR "${THIRDPARTY_DIR}/grpc/build/third_party/protobuf/include/google/protobuf")
endif()
...
if (NOT DEFINED PROTOC_EXECUTABLE)
  set(PROTOC_EXECUTABLE "${THIRDPARTY_DIR}/grpc/bin/protoc${CMAKE_EXECUTABLE_SUFFIX}")
endif()
...
set(OPENSSL_DIR "${THIRDPARTY_DIR}/openssl/build/${CMAKE_SYSTEM_NAME}${ABI_SUBFOLDER_NAME}")
...
set(RocksDB_DIR "${THIRDPARTY_DIR}/rocksdb/lib/cmake/rocksdb")
set(RocksDB_INCLUDE_DIR "${THIRDPARTY_DIR}/rocksdb/include")
find_package(RocksDB CONFIG REQUIRED)
include_directories(${RocksDB_INCLUDE_DIR})

# --------------------------------------------------------
# Set config of Microsoft.GSL
set(GSL_INCLUDE_DIR "${THIRDPARTY_DIR}/GSL/include")
include_directories(${GSL_INCLUDE_DIR})

# --------------------------------------------------------
# Set config of spdlog v1.4.2
set(spdlog_DIR "${THIRDPARTY_DIR}/spdlog/lib/cmake/spdlog")
...
set(tsl_hat_trie_DIR "${THIRDPARTY_DIR}/hat-trie/lib/cmake/tsl_hat_trie")
set(tsl_hat_trie_INCLUDE_DIR "${THIRDPARTY_DIR}/hat-trie/include")
find_package(tsl_hat_trie CONFIG REQUIRED)
include_directories(${tsl_hat_trie_INCLUDE_DIR})

# --------------------------------------------------------
# Set config of libp2p
set(libp2p_DIR "${THIRDPARTY_DIR}/libp2p/lib/cmake/libp2p")
set(libp2p_LIBRARY_DIR "${THIRDPARTY_DIR}/libp2p/lib")
set(libp2p_INCLUDE_DIR    "${THIRDPARTY_DIR}/libp2p/include")
find_package(libp2p CONFIG REQUIRED)
include_directories(${libp2p_INCLUDE_DIR})

# --------------------------------------------------------
# Set config of ipfs-lite-cpp
set(ipfs-lite-cpp_DIR "${THIRDPARTY_DIR}/ipfs-lite-cpp/cmake/ipfs-lite-cpp")
set(ipfs-lite-cpp_INCLUDE_DIR "${THIRDPARTY_DIR}/ipfs-lite-cpp/include")
set(ipfs-lite-cpp_LIB_DIR "${THIRDPARTY_DIR}/ipfs-lite-cpp/lib")
set(CBOR_INCLUDE_DIR "${THIRDPARTY_DIR}/ipfs-lite-cpp/include/deps/tinycbor/src")
...
set(ipfs-pubsub_INCLUDE_DIR "${THIRDPARTY_DIR}/ipfs-pubsub/include")
set(ipfs-pubsub_DIR "${THIRDPARTY_DIR}/ipfs-pubsub/lib/cmake/ipfs-pubsub")
find_package(ipfs-pubsub CONFIG REQUIRED)
include_directories(${ipfs-pubsub_INCLUDE_DIR})

# --------------------------------------------------------
# Set config of Boost.DI
set(Boost.DI_INCLUDE_DIR "${THIRDPARTY_DIR}/Boost.DI/include")
set(Boost.DI_DIR "${THIRDPARTY_DIR}/Boost.DI/lib/cmake/Boost.DI")
find_package(Boost.DI CONFIG REQUIRED)
include_directories(${Boost.DI_INCLUDE_DIR})

# --------------------------------------------------------
# Set config of Boost project
set(_BOOST_ROOT "${THIRDPARTY_DIR}/boost/build/${CMAKE_SYSTEM_NAME}${ABI_SUBFOLDER_NAME}")
...
set(ed25519_DIR "${THIRDPARTY_DIR}/ed25519/lib/cmake/ed25519")
set(ed25519_INCLUDE_DIR "${THIRDPARTY_DIR}/ed25519/include")
find_package(ed25519 CONFIG REQUIRED)
include_directories(${ed25519_INCLUDE_DIR})

# --------------------------------------------------------
# Set config of sr25519-donna
set(sr25519-donna_DIR "${THIRDPARTY_DIR}/sr25519-donna/lib/cmake/sr25519-donna")
set(sr25519-donna_INCLUDE_DIR "${THIRDPARTY_DIR}/sr25519-donna/include")
find_package(sr25519-donna CONFIG REQUIRED)
include_directories(${sr25519-donna_INCLUDE_DIR})

# --------------------------------------------------------
# Set RapidJSON config path
set(RapidJSON_DIR "${THIRDPARTY_DIR}/rapidjson/lib/cmake/RapidJSON")
set(RapidJSON_INCLUDE_DIR "${THIRDPARTY_DIR}/rapidjson/include")
...
set(binaryen_INCLUDE_DIR "${THIRDPARTY_DIR}/binaryen/include")
set(binaryen_LIBRARIES "${THIRDPARTY_DIR}/binaryen/lib")
set(binaryen_DIR "${THIRDPARTY_DIR}/binaryen/lib/cmake/binaryen")
...
set(libsecp256k1_INCLUDE_DIR "${THIRDPARTY_DIR}/libsecp256k1/include")
set(libsecp256k1_LIBRARY_DIR "${THIRDPARTY_DIR}/libsecp256k1/lib")
set(libsecp256k1_DIR "${THIRDPARTY_DIR}/libsecp256k1/lib/cmake/libsecp256k1")
find_package(libsecp256k1 CONFIG REQUIRED)
include_directories(${libsecp256k1_INCLUDE_DIR})

# --------------------------------------------------------
# Set config of xxhash
set(xxhash_INCLUDE_DIR "${THIRDPARTY_DIR}/xxhash/include")
set(xxhash_LIBRARY_DIR "${THIRDPARTY_DIR}/xxhash/lib")
set(xxhash_DIR "${THIRDPARTY_DIR}/xxhash/lib/cmake/xxhash")
